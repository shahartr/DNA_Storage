...
def main():
    for i in range(8):
        ...
        logging.basicConfig(filename=f'run_{i+1}_log.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
        ...
        with open(f'special_folder/output_14_len_primer_final_primers3_run_{i+1}.txt', 'w') as f:
