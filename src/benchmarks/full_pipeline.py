...
MAX_INTER_COMP = 10
MIN_HAM = 6
nupack_model = nupack.Model(material='dna', celsius=37)
MIN_GC = 0.45
MAX_GC = 0.55
MIN_GC_CLAMPS = 3
        ...
        if check_melting_temp(primer):
            ...
            if trie.is_valid_primer_no_info(primer, MIN_HAM):
                ...
                if check_if_contains_fixed_length_complement_patterns_in_primers_set(primer,
                    ...
                    if hairpin_homo_dimer_check(primer):
...
def run2(primers):
    ...
    with open('final_20_length5.txt', 'w') as f:
